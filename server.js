...
async function getdatafromblockchain(contractAddress){
 ...
 const {generateQRCode} = require("./qr-gen");
 ...
 app.post('/mintnft',async (req, res) => {
   ...
   // const imageURI = req.body.imageURI
    ...
    const ArtiId = req.body.arti_id;
    const asseturl=req.body.imageurl;
    const savepath="Genrated-QR-Code.png";
    console.log("user id is:-",userid)

    console.log(asseturl,savepath);
    generateQRCode(asseturl,savepath);
    
    const qrcode='./Genrated-QR-Code.png';
    if (!tokenURI) {
        ...
        try {
            ...
            web3.eth.sendSignedTransaction(signedTx.rawTransaction)
                ...
                .once('receipt', (receipt) => {
                    // console.log(receipt)
                    const verifyUrl = `https://mumbai.polygonscan.com/${contractAddress}`;// create the veryfy url  
                    console.log("v url:-",verifyUrl)
                    var filepath1 ='polyscan-QR-code.png';  
                    generateQRCode(verifyUrl,filepath1);
                    ...
                    if (receipt.status === true || receipt.status === '0x1') {
                        ...
                        res.json({
                            ...
                            QRCode:'genarated successfully'+qrcode,
                            IPFSurl:asseturl
